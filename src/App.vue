...
<template>
  <div class="flex flex-row justify-center text-blue-200 items-center w-screen h-screen">
    <div class="flex flex-col justify-center">
      ...
      <div class="w-5/6 relative mb-7 m-auto">
        ...
        <input type="email" autocomplete="email" name="" placeholder="Email address" id=""
          class="font-medium w-full text-sm bg-neutral-800 pl-9 px-3 py-3 rounded-md bg-transparent border border-neutral-500">
      </div>
  ...
  <div v-if="showModal"
    ...
    <div
      class="w-1/4 p-7 bg-neutral-900 rounded-2xl from-gray-900 to-neutral-900 flex flex-col items-center  bg-gradient-to-r">
    ...
    <p class=" text-base font-bold  text-center text-neutral-600 mb-12 ">You'll be informed as soon as CopyNSync is
      ready!
    </p>
  </div>
</div></template>
